...
fun sendHttpRequest(url: URL, requestMethod: String, requestProperties: Array<String>, postData: Array<String> = emptyArray()): String{
    ...
    if (connection.responseCode == HttpURLConnection.HTTP_OK){
        ...
        println("Failed to get Spotify token!")
