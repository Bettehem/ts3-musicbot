 ...
 */
fun getSoundCloudPlaylistTracks(link: String): ArrayList<Track> {
            ...
            HttpURLConnection.HTTP_OK -> {
                ...
                try {
                    ...
                    for (item in tracks) {
                        item as JSONObject
                        try {
                            trackList.add(getSoundCloudTrack("https://api.soundcloud.com/tracks/${item.getInt("id")}"))
                        } catch (e: Exception) {
 ...
 */
fun getSoundCloudTrack(link: String): Track {
    return try {
